...
// const { pause, resume } = useIntervalFn(refreshTransactions, 60000, {
//   immediate: false,
// });
...
const usedSymbols = computed(() => {
  return bingXTransactionsStore.allSymbols
    .filter((x) => !selectedSymbols.value.includes(x))
    .sort();
});
    ...
    <div class="mb-4 flex items-center justify-between">
      ...
      <div class="flex gap-2">
        <Listbox v-model="selectedSymbols" multiple>
          <ListboxButton
            class="focus:ring-opacity-50 rounded bg-violet-500 px-4 py-1 text-white transition hover:bg-violet-600 focus:ring-2 focus:ring-blue-500 focus:outline-none"
          >
            Hide Symbols
          </ListboxButton>
          <ListboxOptions
            class="absolute top-14 rounded-md bg-slate-600 py-2 text-xs"
          >
            <ListboxOption
              ...
              :key="symbol"
              :value="symbol"
              class="cursor-pointer px-4 py-0.5 hover:bg-slate-700"
              v-slot="{ selected }"
            >
              <li
                class="relative"
        ...
        <button
          ...
          class="focus:ring-opacity-50 rounded bg-amber-500 px-4 py-1 text-white transition hover:bg-amber-600 focus:ring-2 focus:ring-amber-500 focus:outline-none"
        >
          <span>Config</span>
        </button>
      </div>
              ...
              <div class="flex gap-0.5">
                ...
                <span
                  :class="{
                    ...
                    'text-violet-400':
                      item.currentOpenLong > 0 && item.currentOpenLong < 13,
              ...
              <div class="flex gap-0.5">
                ...
                <span
                  :class="{
                    ...
                    'text-violet-400':
                      item.currentOpenShort > 0 && item.currentOpenShort < 13,
